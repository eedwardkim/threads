...
const generationGlobal = globalThis as typeof globalThis & {
  __threadsGenerationControllers?: Map<string, AbortController>;
};
const controllers = generationGlobal.__threadsGenerationControllers ??= new Map<string, AbortController>();
